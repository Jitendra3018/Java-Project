...
class student_data implements ActionListener{
    JFrame f;
    ...
    String s_id,name,age,address,dob,phone,f_name,email,gender,clas;
    JButton b1,b2;
    ImageIcon icon;

    student_data(String e_id){
        try{
            conn con = new conn();
            String str = "select * from student where id = '"+e_id+"'";
